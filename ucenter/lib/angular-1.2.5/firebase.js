(function () {
    ...
    s.F = function (a) {
        ...
        if (a instanceof K)for (c = a.Z; c < a.m.length; c++)b.push(a.m[c]); else {
            a = a.split("/");
    ...
    function L(a, b) {
        for (var c = b instanceof K ? b : new K(b), d = a, e; (e = F(c)) !== l;)d = new Na(e, d, ua(d.z.children, e) || new Ma), c = Ka(c);
        return d
    }
    ...
    s.remove = function (a, b) {
        var c, d;
        c = this;
        if (0 > b(a, c.key))!c.left.f() && (!c.left.O() && !c.left.left.O()) && (c = cb(c)), c = c.copy(l, l, l, c.left.remove(a, b), l); else {
            c.left.O() && (c = db(c));
    ...
    lb.prototype.update = function (a, b) {
        ...
        if (v(a))for (; e < b;)c[d++] = a.charCodeAt(e++), 64 == d && (mb(this, c), d = 0); else for (; e < b;)c[d++] = a[e++], 64 == d && (mb(this, c), d = 0);
        this.ob = d;
        this.Sc += b
    };
    function nb() {
    ...
    function nc(a, b) {
        ...
        a:{
            ...
            for (var e = c.length, f = v(c) ? c.split("") : c, h = 0; h < e; h++)if (h in f && d.call(j, f[h])) {
                d = h;
                break a
            }
            d = -1
        ...
        function c() {
            if (!d.Ia) {
                d.ja = new Jc(function (a, b, c, e, f) {
                    ...
                    if (d.ja)if (d.Fa && (clearTimeout(d.Fa), d.Fa = l), d.kb = k, "start" == a)d.id = b, d.fd = c; else if ("close" === a)if (b) {
                        d.ja.fc = o;
                        var h = d.cd;
                        h.qc = b;
                        h.Ja = function () {
    ...
    function Lc(a) {
        if (a.mc && a.fc && a.Ic.count() < (0 < a.Db.length ? 2 : 1)) {
            ...
            b.pw = a.Ed;
            b.ser = a.sc;
            for (var b = a.Mb(b), c = "", d = 0; 0 < a.Db.length;)if (1870 >= a.Db[0].Yc.length + 30 + c.length) {
    ...
    function Qc(a, b) {
        return function (c) {
            ...
            } else b === a.A ? (d = Vb("t", c), c = Vb("d", c), "c" == d ? "t"in c && (c = c.t, "a" === c ? (a.A.start(), a.e("sending client ack on secondary"), a.A.send({t: "c", d: {t: "a",
    ...
    s.dd = function () {
        ...
        if (this.Na)this.hb ? this.rb && (3E4 < (new Date).getTime() - this.rb && (this.pa = 1E3), this.rb = l) : (this.e("Window isn't visible.  Delaying reconnect."), this.pa = 3E5, this.Cc = (new Date).getTime()), a = Math.max(0, this.pa - ((new Date).getTime() - this.Cc)), a *= Math.random(), this.e("Trying to reconnect in " +
            a + "ms"), Yc(this, a), this.pa = Math.min(3E5, 1.3 * this.pa); else for (var c in this.Hb)delete this.Hb[c];
        this.Ub(o)
    };
    s.Ha = function () {
        this.Na = o;
    ...
    function Dd(a, b, c, d, e) {
        ...
        for (G = Wa(O); I !== l || G !== l;) {
            ...
            if (0 > c)f = ua(q, I.key), u(f) ? (n.push({wc: I, Qc: i[f]}), i[f] = l) : (t[I.key] = m.length, m.push(I)), f = k, I = Wa(x); else {
                if (0 < c)f = ua(t, G.key), u(f) ? (n.push({wc: m[f], Qc: G}), m[f] = l) : (q[G.key] = i.length, i.push(G)), f = k; else {
                    c = b.F(G.key);
        ...
        for (h = 0; h < m.length; h++)if (q = m[h])c = b.F(q.key), Cd(a, c, q.value, P), e.push(new W("child_removed", q.value, q.key));
        for (h = 0; h < i.length; h++)if (q = i[h])c = b.F(q.key), m = d.da(q.key, q.value), Cd(a, c, P, q.value), e.push(new W("child_added", q.value, q.key, m));
    ...
    Kd.prototype.Nb = function (a, b, c, d, e) {
        ...
        var m = a.La();
        if (i.contains(m))a = i.get(m), ud(a, b, c, d, e); else {
            var n = this.g.qa.Q(f), n = a = "default" === a.La() ? new zd(a, n) : new Hd(a, n);
            if (Gd(i) || Ld(h))i.add(m, n), i.S || (i.S = n.J.path); else {
                var p, q;
    ...
    function Nd(a, b, c, d, e) {
        ...
        if (h = f) {
            ...
            for (var i = f.ma.length - 1; 0 <= i; i--) {
                var m = f.ma[i];
                if ((!c || m.type === c) && (!d || m.W === d) && (!e || m.T === e))if (f.ma.splice(i, 1), h = k, c && d)break
            }
            h = h && !(0 < f.ma.length)
        }
        (c = h) && a.remove(b);
    ...
    function Od(a, b, c, d, e, f) {
        ...
        if (0 < i.length && !c) {
            ...
            if (!Gd(b)) {
                ...
                var x = [], O = function (b) {
                    var c = b.k();
                    if (c && Fd(c))x.push(c.path()), c.wa == l && c.setActive(Md(a, c)); else {
                        if (c) {
    ...
    s.update = function (a, b, c) {
        ...
        if (e)Nb("update() called with empty data.  Don't do anything."), X(c, "ok"); else {
            var q = this;
    ...
    function ae(a, b) {
        ...
        if (0 !== e.length) {
            for (var f = c = U(a.g.la, d), h = [], i = 0; i < e.length; i++) {
                ...
                if (5 === e[i].status)n = k, p = e[i].lc; else if (1 === e[i].status)if (25 <= e[i].kd)n = k, p = "maxretry"; else {
    ...
    $.prototype.update = function (a, b) {
        ...
        for (f in a)e = o;
        if (e)Nb("onDisconnect().update() called with empty data.  Don't do anything."), X(b, k); else {
            e = c.u;
            f = d.toString();
            var h = function (e) {
    ...
    function J() {
        ...
        if (arguments[0]instanceof Xd)c = arguments[0], a = arguments[1]; else {
            ...
            b = new K(f);
            e = b.toString();
            if (!(d = !v(a.host)))if (!(d = 0 === a.host.length))if (!(d = !xa(a.ub)))if (d =
    ...
    J.prototype.F = function (a) {
        ...
        if (ga(a))a = String(a); else if (!(a instanceof K))if (F(this.path) === l) {
            var b = a;
            b && (b = b.replace(/^\/*\.info(\/|$)/, "/"));
            Ga("Firebase.child", b)
